...
import "@/app/Stylepages/cricketpage.css";
const cricket = () => {
  return (
    <div class="Cpage py-2">
      <div class="container-fluid">
        <div class="row text-center border border-3 p-5">
          <div className="col">
          ...
          <div className="col">
            ...
            >
              <option selected>Select Your First Team</option>
          ...
          <div className="col">
            <select
              ...
              aria-label="Default select example"
            >
              <option selected>Select Your Second Team</option>
              <option value="CSK">Chennai Super Kings</option>
              <option value="DC">Delhi Capitals</option>
              <option value="PBKS">Punjab Kings</option>
              <option value="KKR">Kolkata Knight Riders</option>
          ...
          <div className="col">
            <button className="btn btn-info" onClick=""> Click To Make Team</button>
          </div>
        </div>
